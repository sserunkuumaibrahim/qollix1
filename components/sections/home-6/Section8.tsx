...
export default function Section8() {
    return (
        <>
            ...
            <div className="tes6 sp overflow-hidden" id="tes" style={{ backgroundImage: "url(assets/img/bg/tes6-bg.jpg)" }}>
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="heading6-w">
                                <span className="span" data-aos="zoom-in-left" data-aos-duration={700}>
                                    <img src="assets/img/icons/span6.svg" alt="" /> our testimonials
                                </span>
                            ...
                            <div className="tes6-all-slider" data-aos="fade-up" data-aos-duration={800}>
                                <Swiper {...swiperOptions} className="tes6-slider">
                                    <SwiperSlide className="single-slider">
                                        <img src="assets/img/icons/qute6.png" alt="" className="qute" />
                                        <div className="stars">
                                            <ul>
                                                <li>
