...
export default function Section8() {
    return (
        <>
            {/*=====CONTACT AREA START=======*/}
            <div className="contact5 sp overflow-hidden" id="contact">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="heading5">
                                ...
                                <div className="contact3-box" data-aos="fade-right" data-aos-duration={900}>
                                    <div className="icon">
                                ...
                                <div className="contact3-box" data-aos="fade-right" data-aos-duration={1100}>
                                    <div className="icon">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="button">
                                                <button className="theme-btn4" type="submit">
                                                    Submit Now
                                                    <span>
