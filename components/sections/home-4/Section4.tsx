...
export default function Section4() {
    ...
    return (
        <>
            {/*===== PRIICING AREA START =======*/}
            <div className="pricing-plan-page2 sp overflow-hidden" id="pricing">
                        ...
                        <div className="container">
                            ...
                            <div className="tab-content">
                                <div id="monthly" style={{ display: isMonthly ? "block" : "none" }}>
                                    <div className="row">
                                        <div className="col-md-6 col-lg-4">
                                            <div className="pricing-box2" data-aos="fade-up" data-aos-duration={700}>
                                        ...
                                        <div className="col-md-6 col-lg-4">
                                            <div className="pricing-box2 active" data-aos="fade-up" data-aos-duration={900}>
                                                <div className="pricing-box-single">
                                                    <div className="heading2">
                                                        <h5>Contract</h5>
                                                        <p>Our pricing is designed to be transparent and tailored to your specific needs.</p>
                                        ...
                                        <div className="col-md-6 col-lg-4">
                                            <div className="pricing-box2" data-aos="fade-up" data-aos-duration={1000}>
                                                <div className="pricing-box-single">
                                                    <div className="heading2">
                                                        <h5>Didact</h5>
                                                        <p>Our pricing is designed to be transparent and tailored to your specific needs.</p>
                                ...
                                <div id="yearly" style={{ display: isMonthly ? "none" : "block" }}>
                                    <div className="row">
                                        <div className="col-md-6 col-lg-4">
                                            <div className="pricing-box2 active">
                                                <div className="pricing-box-single">
                                                    <div className="heading2">
                                                        <h5>Temporary</h5>
                                                        <p>Our pricing is designed to be transparent and tailored to your specific needs.</p>
